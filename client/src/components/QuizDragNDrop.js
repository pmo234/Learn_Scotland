    ...
    return (
        ...
        <StartBlock>
            <DivContainer id="div1" onDrop={drop} onDragOver={allowDrop}>
                <Word draggable="true" onDragStart={drag} id="drag1" width="88" height="31">Perth</Word>
            </DivContainer>
            <DivContainer id="div2" onDrop={drop} onDragOver={allowDrop}>
                <Word draggable="true" onDragStart={drag} id="drag2" width="88" height="31">Edinburgh</Word>
            </DivContainer>
            <DivContainer id="div3" onDrop={drop} onDragOver={allowDrop}>
                <Word draggable="true" onDragStart={drag} id="drag3" width="88" height="31">Glasgow</Word>
            </DivContainer>
            <DivContainer id="div4" onDrop={drop} onDragOver={allowDrop}>
                <Word draggable="true" onDragStart={drag} id="drag4" width="88" height="31">John o'Groats</Word>
            </DivContainer>
            <DivContainer id="div5" onDrop={drop} onDragOver={allowDrop}>
                <Word draggable="true" onDragStart={drag} id="drag5" width="88" height="31">Aberdeen</Word>
            </DivContainer>

...
const QuizSingle = () => {
    ...
    const onChange = (e) => {
        ...
        if (answer in formData) {
            ...
            if (score === 2){
                document.getElementById('displayCorrect').innerHTML = `20 CORRECT ANSWERS!!!`;
            ...
            <AnswerBox>
                <Form>
                    <label htmlFor="answer">
                        <InputAnswer autoFocus id="answer" name="answer" onChange={onChange} placeholder="Answer" type="text"></InputAnswer>
                    </label>
                </Form>
            </AnswerBox>
